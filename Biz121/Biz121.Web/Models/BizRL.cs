        ...
        private string GetTransportTypeData()
        {
            ...
            else if (TransportType == "SFTP")
            {
                string customProps =
                    ...
                    "<ClientAuthenticationMode vt=\"8\">Password</ClientAuthenticationMode><PollingInterval vt=\"3\">0</PollingInterval><Password vt=\"1\" >Replaceit</Password>" +
                    ...
                    "<PollingIntervalUnit vt=\"8\">Seconds</PollingIntervalUnit></CustomProps>";
